 ...
 * with the <i>discriminator</i> set to one of the LAPPS URI.
 * <p>
 * See <a href="http://vocab.lappsgrid.org/discriminators.html">http://vocab.lappsgrid.org/discriminators.html</a>
 * for a list of all URI used by LAPPS services.
 *
